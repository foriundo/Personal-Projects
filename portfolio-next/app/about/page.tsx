    ...
    <Section>
      <div className="mx-auto max-w-6xl px-4 py-24 text-center">
        ...
        <h1 className="mt-4 text-4xl md:text-6xl font-semibold tracking-tight">
          Dog lover, Coffee enthusiast, and Software Engineer
        </h1>
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <Link href="/experience#projects" className="rounded-md bg-black text-white dark:bg-white dark:text-black px-5 py-2 text-sm">
            View Projects
          </Link>
